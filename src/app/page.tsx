    ...
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        <div className="flex items-end justify-between gap-2">
          ...
          <Link href="/search" className="text-sm text-teal-700 hover:underline">
            去检索 →
          </Link>
        </div>
          ...
          {demoSubstances.map((s) => (
            <li key={s.id}>
              <Link
                ...
                className="block h-full rounded-xl border border-slate-200 bg-white p-4 shadow-sm hover:border-teal-300 transition"
              >
